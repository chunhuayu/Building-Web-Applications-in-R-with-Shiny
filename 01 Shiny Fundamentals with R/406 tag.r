...
# Tab 1 should be called "Plot" and should contain the scatterplot, a line break, 
# and the h5() header text for number of observations.
# Tab 2 should be called "Data" and should contain a line break and the data table. 
# The line break will place the table a little below the top of the tab.
