...
# it will not currently work on the DataCamp platform. 
# It is important, however, to learn how to do this for your future Shiny apps!

### Instructions

# Use observeEvent() to print a message to the console when the action button is clicked.
# Set up a table output that will print only when action button is clicked, 
# but not when other inputs that go into the creation of that output changes.
