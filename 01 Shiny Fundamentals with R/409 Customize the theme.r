...
# Run the code but do not submit the solution.

# Then, select a theme you like using the theme selector drop down menu that should appear in the app that 
# launches when you run the code.
# Apply it to your app using the argument theme in the fluidPage() function, and remove the theme selector.
